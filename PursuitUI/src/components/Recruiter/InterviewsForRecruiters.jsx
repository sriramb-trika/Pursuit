...
export default function InterviewForRecruiters (props) {
  ...
  useEffect(()=>{
    axios.get(`${process.env.REACT_APP_PURSUIT_URL}/interviewSchedule/getAllInterviewSchedulesForRecruiter/ `,
    {
